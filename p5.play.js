 ...
 * remote location may be boxed due to your browser's built-in
 * security.
 *
...
/**
   * A Sprite is the main building box of p5.play:
...
// For details on why these docs aren't in a YUIDoc comment box, see:
//
...
function Sprite(pInst, _x, _y, _w, _h) {
  ...
  */
  ...
  this._collideWithOne = function(type, other, callback) {
    ...
    // See another box near the end of this method that puts them back.
    ...
    // See another box before velocity changes that sets these up.
    type = originalType;
